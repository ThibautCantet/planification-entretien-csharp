...
Fonctionnalité: Création d'un recruteur
  ...
  Scénario: Un recruteur n'est pas crée quand sont email n'est pas soat.fr
    Etant donné un recruteur "Java" ("recruteur@email.com") avec "3" ans d’expériences
    Quand on tente d'enregistrer le recruteur
  ...
  Scénario: Un recruteur n'est pas crée quand son nombre d'années d'expérience est négatif
    Etant donné un recruteur "Java" ("recruteur@soat.fr") avec "-1" ans d’expériences
    Quand on tente d'enregistrer le recruteur
    Alors le recruteur n'est pas enregistré
  ...
  Scénario: Un recruteur n'est pas crée quand son email est incorrect
    Etant donné un recruteur "Java" ("recruteur") avec "3" ans d’expériences
    Quand on tente d'enregistrer le recruteur
    Alors le recruteur n'est pas enregistré
