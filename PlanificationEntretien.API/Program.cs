...
void SeedData(IServiceProvider services)
{
    using (var scope = services.CreateScope())
    {
        ...
        try
        {
            ...
            var candidat1Id = candidatRepo.Save(new Candidat("Java", "alice@example.com", 3));
            var candidat2Id = candidatRepo.Save(new Candidat("CSharp", "bob@example.com", 2));
            var candidat3Id = candidatRepo.Save(new Candidat("Python", "charlie@example.com", 5));
