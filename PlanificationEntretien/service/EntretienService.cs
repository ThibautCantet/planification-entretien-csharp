...
namespace Planification
{
    public class EntretienService
    {
        ...
        public EntretienService(IEntretienRepository entretienRepository, IEmailService emailService, ICandidatRepository candidatRepository, IRecruteurRepository recruteurRepository)
        {
